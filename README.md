...
- [`app`](docker-compose.yml:2)：Node.js 应用服务
- [`mysql`](docker-compose.yml:22)：MySQL 8 数据库服务
...
Compose 默认数据库配置见 [`docker-compose.yml`](docker-compose.yml:10) 和 [`docker-compose.yml`](docker-compose.yml:24)。
...
- [`ghcr.io/<仓库所有者>/simplecms`](.github/workflows/docker-image.yml:15)
